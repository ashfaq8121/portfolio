...
// Was "@cf/meta/llama-3.1-8b-instruct" — Cloudflare deprecated this model on
// 2026-05-30 (same deprecation that broke chat.ts's original MODEL choice).
// Using the same confirmed-active model as chat.ts so grading calls don't
// fail with the same "model deprecated" error once CF credentials are set.
const GRADING_MODEL = "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
